...
cp /etc/nginx/conf.d/primeira-troca-frontend.conf /etc/nginx/conf.d/primeira-troca-frontend.conf.backup
cp /etc/nginx/conf.d/primeira-troca-api.conf /etc/nginx/conf.d/primeira-troca-api.conf.backup
echo "✅ Backup criado"
echo ""
